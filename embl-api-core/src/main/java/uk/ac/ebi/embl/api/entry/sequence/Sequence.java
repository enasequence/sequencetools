...
public class Sequence extends AbstractSequence implements HasOrigin,
		Serializable {
	...
	private SequenceAccession sequenceAccession = new SequenceAccession(null,
			null);
