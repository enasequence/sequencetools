...
/**
 * This annotation is a part of the rule-based validation framework. It should 
 * be used to annotate check classes and used to disable the check only for the given scope
 * 
 */
