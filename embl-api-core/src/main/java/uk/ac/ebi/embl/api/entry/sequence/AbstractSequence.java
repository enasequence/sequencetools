...
public abstract class AbstractSequence implements Serializable {
	...
	public byte[] getSequenceByte(Long beginPosition, Long endPosition)
	{
		...
		if (beginPosition == null || endPosition == null || (beginPosition > endPosition) || beginPosition < 1 || endPosition > sequence.length)
		{
			return null;
		}
	...
	{
		return (new ReverseComplementer()).reverseComplementByte(getSequenceByte(beginPosition, endPosition));
	}
