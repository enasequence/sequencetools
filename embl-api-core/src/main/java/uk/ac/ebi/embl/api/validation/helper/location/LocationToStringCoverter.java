...
{
	public static String renderCompoundLocation(
			CompoundLocation<Location> compoundLocation)
	{
		...
		if (locations.size() > 0)
		{
			...
			{// need to be a bit clever regarding wheter to render left and
				// right partial
			...
			boolean leftPartial, boolean rightPartial)
	{
				...
				&& location.getEndPosition() == null)
		{
			renderBase(
				...
				&& location
						.getBeginPosition()
						.equals(location.getEndPosition()))
		{
			renderBase(
					block,
					location.getBeginPosition(),
	...
	private static void renderBase(StringBuilder block, Long position,
			boolean isComplement, boolean leftPartial, boolean rightPartial)
	{
		// Partiality.
		if (isComplement)
		{
	...
	private static void renderRange(StringBuilder block, Long beginPosition,
			Long endPosition, boolean isComplement, boolean leftPartial,
	...
	private static void renderBetween(StringBuilder block, Long beginPosition,
			Long endPosition, boolean isComplement, boolean leftPartial,
			boolean rightPartial)
	{
		renderRangeOrBetween(
	...
	private static void renderRangeOrBetween(StringBuilder block,
			Long beginPosition, Long endPosition, boolean isComplement,
