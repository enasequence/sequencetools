...
public class EntryFactory  {
	...
	public Assembly createAssembly( 
			String accession, Integer version, 
			Long primaryBeginPosition, Long primaryEndPosition, 
			boolean primaryComplement, 
			Long secondaryBeginPosition, Long secondaryEndPosition) {
		
		LocationFactory locationFactory = new LocationFactory();
		RemoteRange primarySpan = locationFactory.createRemoteRange(
				accession, version, primaryBeginPosition, primaryEndPosition, 
				primaryComplement);
		LocalRange secondarySpan = locationFactory.createLocalRange(
				secondaryBeginPosition, secondaryEndPosition); 
