...
public class AccessionFormatException extends RuntimeException {
	...
	public AccessionFormatException(String message, Throwable cause) {
		super(message, cause);
	}

	public AccessionFormatException(String message) {
		super(message);
	}

	public AccessionFormatException(Throwable cause) {
		super(cause);
	}
