...
{
	@CheckDataSet("obsoletefeature-to-feature.tsv")
	private DataSet obsoleteFeatureDataSet;
	...
	public ObsoleteFeaturetoNewFeatureFix(DataSet obsoleteFeatureDataSet)
	{
		this.obsoleteFeatureDataSet = obsoleteFeatureDataSet;
	}
