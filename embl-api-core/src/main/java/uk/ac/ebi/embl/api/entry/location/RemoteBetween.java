...
public class RemoteBetween extends Between implements RemoteLocation, Serializable {
	...
	protected RemoteBetween(String accession, Integer version, Long beginPosition, Long endPosition, boolean complement) {
		super(beginPosition, endPosition, complement);
		this.sequenceAccession = new SequenceAccession(accession, version);
	}
	
	protected RemoteBetween(String accession, Integer version, Long beginPosition, Long endPosition) {
	...
	public boolean equals(Object obj) {
		if (obj != null && obj instanceof RemoteBetween) {		
			final RemoteBetween other = (RemoteBetween) obj;
