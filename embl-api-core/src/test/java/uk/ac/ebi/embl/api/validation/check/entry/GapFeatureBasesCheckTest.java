...
public class GapFeatureBasesCheckTest {
	...
	public void setUp() {
		...
		ByteBuffer sequenceBuffer=ByteBuffer.wrap("agagagagagagannnnnnnagagagagagagagagagagagag".getBytes());
    ...
    public void testCheck_ComplexLocation() {
        ...
        /**
         * this should bail out quietly if the location on the gap feature is complex - other checks to tell submitters
         * off for this.
         */
        Feature feature = featureFactory.createFeature(Feature.GAP_FEATURE_NAME);
        Order<Location> location = new Order<Location>();
