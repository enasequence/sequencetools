...
public class MoleculeTypeAndQualifierFixTest
{
	...
	public void testCheck_withInvalidMol_type()
	{
		...
		assertEquals(1, validationResult.getMessages("MoleculeTypeAndQualifierFix", Severity.FIX).size());
	...
	public void testCheck_withvalidMol_type()
	{
		...
		assertEquals(0, validationResult.getMessages("MoleculeTypeAndQualifierFix", Severity.FIX).size());
