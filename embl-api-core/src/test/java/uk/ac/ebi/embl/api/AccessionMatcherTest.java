...
public class AccessionMatcherTest {
    ...
    private final List<String> validNonWGSAccessions = Arrays.asList("AB12345",
            "AB123456",
            "AB12345678",
            "A12345",
            "A123456"
    ...
    private final List<String> inValidNonWGSAccessions = Arrays.asList(null,
            "",
    ...
    private final List<String> validWGSAccessions = Arrays.asList("AABBCC01123456789",//NEW FORMAT
            "AABBCC011234567",
            "AABBCC0112345678",
            "AABBCC01123456789",
    ...
    private final List<String> inValidWGSAccessions = Arrays.asList(null,
            "",
    ...
    private final List<String> validWGSMaster = Arrays.asList(
    ...
    private final List<String> inValidWGSMaster = Arrays.asList(null,
            "",
    ...
    public void testProteinIds() {
        ...
        assertEquals("VAB0000000", AccessionMatcher.getProteinAccession("VAB0000000.0"));//TODO: make it invalid
