...
public class Type_materialQualifierCheckTest
{
	...
	public void testCheck_withInvalidTypeMaterialFormat()
	{
		...
		sourceFeature.addQualifier(Qualifier.TYPE_MATERIAL_QUALIFIER_NAME, "type strain Cauliflower mosaic viru");
		assertTrue(check.check(sourceFeature).isValid());
	}
	...
	{
		sourceFeature.addQualifier(Qualifier.TYPE_MATERIAL_QUALIFIER_NAME, "type strain of Cauliflower mosaic viru");
	...
	{
		sourceFeature.addQualifier(Qualifier.TYPE_MATERIAL_QUALIFIER_NAME, "type strain of Cauliflower mosaic virus");
		ValidationResult result = check.check(sourceFeature);
