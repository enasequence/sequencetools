...
public class AntiCodonQualifierCheckTest {
	...
	public void testCheck_AnticodonPositionRange() {
		...
		ValidationResult validationResult = check.check(feature);
		assertTrue(!validationResult.isValid());
		assertEquals(1, validationResult.count("AntiCodonQualifierCheck_1",
				Severity.ERROR));
	}
	@Test
	public void testCheck_AnticodonPositionGap() {
		...
		ValidationResult validationResult = check.check(feature);
		assertTrue(!validationResult.isValid());
		assertEquals(1, validationResult.count("AntiCodonQualifierCheck_4",
				Severity.ERROR));
	}
	@Test
	public void testCheck_AnticodonPositionOrder() {
		...
		ValidationResult validationResult = check.check(feature);
		assertTrue(!validationResult.isValid());
		assertEquals(1, validationResult.count("AntiCodonQualifierCheck_2",
				Severity.ERROR));
	}
	@Test
	public void testCheck_AnticodonStartPosition() {
		...
		ValidationResult validationResult = check.check(feature);
		assertTrue(!validationResult.isValid());
		assertEquals(1, validationResult.count("AntiCodonQualifierCheck_3",
				Severity.ERROR));
	}
	@Test
	public void testCheck_AnticodonAminoAcid() {
		...
		ValidationResult validationResult = check.check(feature);
		assertTrue(!validationResult.isValid());
		assertEquals(1, validationResult.count("AntiCodonQualifierCheck_5",
				Severity.ERROR));
	}
