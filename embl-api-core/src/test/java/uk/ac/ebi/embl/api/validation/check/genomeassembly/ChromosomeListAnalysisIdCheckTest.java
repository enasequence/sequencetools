...
public class ChromosomeListAnalysisIdCheckTest
{
	private ChromosomeListAnalysisIdCheck check;
	Origin origin = null;
	...
	public void setUp()
	{
		...
		check = new ChromosomeListAnalysisIdCheck();
	}
	...
	public void testCheck_NoAnalysisId() throws ValidationEngineException
	{
		...
		assertEquals(1, result.count("ChromosomeListMissingAnalysisIDCheck", Severity.ERROR));
	}
	...
	public void testCheck_InvalidAnalysisId() throws ValidationEngineException
	{
		...
		ValidationResult result = check.check(entry);
		assertEquals(1, result.count("ChromosomeListInvalidAnalysisIDCheck", Severity.ERROR));
	}
