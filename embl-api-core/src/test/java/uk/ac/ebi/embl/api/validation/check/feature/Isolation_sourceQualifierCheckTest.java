...
public class Isolation_sourceQualifierCheckTest
{

	private Isolation_sourceQualifierCheck check;
	...
	public void setUp()
	{
		...
		DataRow feature_qualifier_values_row1 = new DataRow(
				"lat_lon",
				"N",
				"Y",
				"Y",
				...
				"22",
				"(null)");
		DataRow feature_qualifier_values_row2 = new DataRow(
				"country",
				"N",
				"Y",
				"Y",
				...
				"21",
				"(null)");
		DataRow feature_qualifier_values_row3 = new DataRow(
				"EC_number",
				"N",
				"Y",
				"Y",
		...
		DataSet feature_qualifier_values_set = new DataSet();
		DataSet feature_regex_groups_set = new DataSet();
		feature_qualifier_values_set.addRow(feature_qualifier_values_row1);
		feature_qualifier_values_set.addRow(feature_qualifier_values_row2);
		feature_qualifier_values_set.addRow(feature_qualifier_values_row3);
		...
		check = new Isolation_sourceQualifierCheck(
				feature_regex_groups_set,
				feature_qualifier_values_set);
	}
	...
	public void testCheck_isolationQualifierwithCountryValue()
	{
		...
		assertEquals(1, result.count("Isolation_sourceQualifierCheck_1", Severity.ERROR));
	}
	...
	public void testCheck_isolationQualifierwithLat_lonValue()
	{
		...
		assertTrue(!result.isValid());
		assertTrue(result.getMessages().size() == 1);
		assertEquals(1, result.count("Isolation_sourceQualifierCheck_2", Severity.ERROR));
	}
}
