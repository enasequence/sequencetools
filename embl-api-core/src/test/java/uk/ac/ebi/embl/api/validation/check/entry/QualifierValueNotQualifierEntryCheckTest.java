...
public class QualifierValueNotQualifierEntryCheckTest {
	...
	public void setUp() {
		...
		check = new QualifierValueNotQualifierEntryCheck(dataSet);
	}
	...
	public void testCheck_NoOrganelle() {
		...
		assertEquals(0, result.count("QualifierValueNotQualifierEntryCheck",
				Severity.ERROR));
	}
	...
	public void testCheck_Organelle() {
		...
		ValidationResult result = check.check(entry);
		assertEquals(1, result.count("QualifierValueNotQualifierEntryCheck",
				Severity.ERROR));
	}
	...
	public void testCheck_Message() {
		...
		Collection<ValidationMessage<Origin>> messages = result.getMessages(
				"QualifierValueNotQualifierEntryCheck", Severity.ERROR);
		assertEquals(
