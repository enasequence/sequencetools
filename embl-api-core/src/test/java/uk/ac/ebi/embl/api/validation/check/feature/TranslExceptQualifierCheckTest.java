...
public class TranslExceptQualifierCheckTest {
	...
	public void setUp() {
		...
		qualifier = qualifierFactory
				.createQualifier(Qualifier.TRANSL_EXCEPT_QUALIFIER_NAME);
	...
	public void testCheck_TranslExceptPositionRange() {
		...
		ValidationResult validationResult = check.check(feature);
		assertTrue(!validationResult.isValid());
		assertEquals(1, validationResult.count("TranslExceptQualifierCheck_1",
				Severity.ERROR));
	}
	@Test
	public void testCheck_TranslExceptPositionGap() {
		...
		ValidationResult validationResult = check.check(feature);
		assertTrue(!validationResult.isValid());
		assertEquals(1, validationResult.count("TranslExceptQualifierCheck_4",
				Severity.ERROR));
	}
	@Test
	public void testCheck_TranslExceptPositionOrder() {
		...
		ValidationResult validationResult = check.check(feature);
		assertTrue(!validationResult.isValid());
		assertEquals(1, validationResult.count("TranslExceptQualifierCheck_2",
				Severity.ERROR));
	}
	@Test
	public void testCheck_TranslExceptStartPosition() {
		...
		ValidationResult validationResult = check.check(feature);
		assertTrue(!validationResult.isValid());
		assertEquals(1, validationResult.count("TranslExceptQualifierCheck_3",
				Severity.ERROR));
	}
	@Test
	public void testCheck_TranslExceptAminoAcid() {
		...
		ValidationResult validationResult = check.check(feature);
		assertTrue(!validationResult.isValid());
		assertEquals(1, validationResult.count("TranslExceptQualifierCheck_5",
				Severity.ERROR));
	}
