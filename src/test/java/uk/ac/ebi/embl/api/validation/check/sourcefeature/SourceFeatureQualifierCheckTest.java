...
public class SourceFeatureQualifierCheckTest {
  ...
  public void testCheck() {
    ...
    assertEquals(0, result.count("SourceFeatureQualifierCheck1", Severity.ERROR));
  }
  ...
  public void testCheck_NoGene() {
    source.addQualifier(qualifierFactory.createQualifier("strain", "BALB/c"));
    ValidationResult result = check.check(entry);
    assertEquals(0, result.count("SourceFeatureQualifierCheck1", Severity.ERROR));
  }
  ...
  public void testCheck_MultipleSourceDifferentOrganism() {
    ...
    source1.addQualifier(qualifierFactory.createQualifier("organism", "Cloning vector pBeloBAC11"));
    source.setFocus(false);
    source1.setFocus(false);
    source.setTransgenic(false);
    source1.setTransgenic(false);
    ValidationResult result = check.check(entry);
    assertEquals(1, result.count("SourceFeatureQualifierCheck2", Severity.ERROR));
  }
  ...
  public void testMultipleSourceMultipleFocus() {
    ...
    ValidationResult result = check.check(entry);
    assertEquals(1, result.count("SourceFeatureQualifierCheck3", Severity.ERROR));
  }
  ...
  public void testFocusMisplacement() {
    ...
    entry.addFeature(geneFeature);
    ValidationResult result = check.check(entry);
    assertEquals(1, result.count("FocusAllowedOnlyInPrimarySource", Severity.ERROR));
  }
  ...
  public void testCheck_multipleTransgenic() {
    ...
    source.addQualifier(Qualifier.TRANSGENIC_QUALIFIER_NAME);
    ValidationResult result = check.check(entry);
    assertEquals(1, result.count("SourceFeatureQualifierCheck4", Severity.ERROR));
  }
  ...
  public void testCheck_withTransgenicandFocus() {
    ...
    source.addQualifier(Qualifier.TRANSGENIC_QUALIFIER_NAME);
    ValidationResult result = check.check(entry);
    assertEquals(1, result.count("SourceFeatureQualifierCheck5", Severity.ERROR));
  }
  ...
  public void testCheck_OrganismSubmittable() {
    ...
    ValidationResult result = check.check(entry);
    assertEquals(0, result.count("SourceFeatureQualifierCheck8", Severity.ERROR));
    SourceFeature source2 = featureFactory.createSourceFeature();
    entry.addFeature(source2);
    source2.addQualifier(
        qualifierFactory.createQualifier("organism", "Pseudendoclonium basiliense"));
