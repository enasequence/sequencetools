...
public class MasterEntryValidationCheckTest extends SubmissionValidationTest {
  ...
  public void testMasterEntrywithoutAssemblyInfo() throws ValidationEngineException {
    ...
    MasterEntryValidationCheck check =
        new MasterEntryValidationCheck(options, new FileValidationCheck.SharedInfo());
  ...
  @Test
  public void testMasterEntryGenomecreation()
    ...
    assertTrue(
        comparator.compare(
            file.getAbsolutePath(), options.processDir.get() + File.separator + "master.dat"));
  }

  @Test
  public void testMasterEntryTranscriptomcreation()
      throws ValidationEngineException, FlatFileComparatorException, IOException {
    options.assemblyInfoEntry = Optional.of(getAssemblyinfoEntry());
    options.source = Optional.of(getSource());
