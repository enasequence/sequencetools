...
public class EC_numberfromProductValueFixTest {
  ...
  public void testEcNumberExtraction() {
    checkEcNumberAndProduct(
        "UDP-3-O-[3-hydroxymyristoyl] / 3-hydroxyacyl-[acyl-carrier-protein] dehydratase [ec:3.5.1.108,4.2.1.123]",
        "UDP-3-O-[3-hydroxymyristoyl] / 3-hydroxyacyl-[acyl-carrier-protein] dehydratase",
        2,
        "3.5.1.108",
        "4.2.1.123");
    checkEcNumberAndProduct(
        "UDP-3-O-[3-hydroxymyristoyl] N-acetylglucosamine deacetylase / 3-hydroxyacyl-[acyl-carrier-protein] dehydratase [ec:3.5.1.1084.2.1.123]",
        "UDP-3-O-[3-hydroxymyristoyl] N-acetylglucosamine deacetylase / 3-hydroxyacyl-[acyl-carrier-protein] dehydratase",
        1,
        "3.5.1.108");
    checkEcNumberAndProduct(
        "UDP- dehydratase [ec:3.5.1.104.2.1.123]", "UDP- dehydratase", 1, "3.5.1.104");
    checkEcNumberAndProduct(
        "dsjhdjkssjsskj9827867807&^&*%^&^&*()- 12.34.2.n",
        "dsjhdjkssjsskj9827867807&^&*%^&^&*()-", 1, "12.34.2.n");
    checkEcNumberAndProduct(
        "mksfkds~~*[ec]kjks[EC=1.2.3.567]", "mksfkds~~*[ec]kjks", 1, "1.2.3.567");
    checkEcNumberAndProduct(
        "mksfkds~~*[ec]kjks[EC=1.2.3.567.678]", "mksfkds~~*[ec]kjks.678]", 1, "1.2.3.567");
    ...
    checkEcNumberAndProduct(
        "mksfkds[ec:1.2.3]kjks[EC=1.2.3.567.678]", "mksfkds[ec:1.2.3]kjks.678]", 1, "1.2.3.567");
    checkEcNumberAndProduct(
        "mksfkds[1.2.3.4]kjks[ec:1.2.3.567.678]", "mksfkdskjks.678]", 2, "1.2.3.4", "1.2.3.567");
    checkEcNumberAndProduct(
        "mksfkds1.2.3.4kjks[ec:1.2.3.567]", "mksfkdskjks", 2, "1.2.3.4", "1.2.3.567");
  ...
  private void checkEcNumberAndProduct(
      String product, String expectedProduct, int noOfEcsExpected, String... ecNumbers) {
