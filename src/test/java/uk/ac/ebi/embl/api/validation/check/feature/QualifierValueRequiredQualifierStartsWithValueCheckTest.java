...
public class QualifierValueRequiredQualifierStartsWithValueCheckTest {
  ...
  public void setUp() {
    ...
    GlobalDataSets.addTestDataSet(
        GlobalDataSetFile.QUALIFIER_VALUE_REQ_QUALIFIER_STARTSWITH_VALUE,
        new DataRow("product", "MHC class I antigen", "gene", "HLA-A"),
  ...
  public void testCheck_withInvalidProductandvalidGene() {
    ...
    assertEquals(
        1, result.count("QualifierValueRequiredQualifierStartsWithValueCheck", Severity.ERROR));
  }
  ...
  public void testCheck_withvalidProductandvalidGene() {
    ...
    ValidationResult result = check.check(feature);
    assertEquals(
        0, result.count("QualifierValueRequiredQualifierStartsWithValueCheck", Severity.ERROR));
  }
  ...
  public void testCheck_Message() {
    ...
    Collection<ValidationMessage<Origin>> messages =
        result.getMessages("QualifierValueRequiredQualifierStartsWithValueCheck", Severity.ERROR);
    assertEquals(
