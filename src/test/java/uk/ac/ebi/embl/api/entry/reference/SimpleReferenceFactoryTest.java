...
public class SimpleReferenceFactoryTest {
	...
	public void testCreateReference() {
		...
		assertEquals(new Integer(2), result.getReferenceNumber());
	...
	public void testCreateBook() {
		Book result = factory.createBook("title", "book title", "1", "10", 
				"publisher");
		assertNotNull(result.getAuthors());
		assertTrue(result.getAuthors().isEmpty());
		assertEquals("title", result.getTitle());
	...
	public void testCreateElectronicReference() {
		ElectronicReference result = factory.createElectronicReference("title", 
				"text");
		assertNotNull(result.getAuthors());
		assertTrue(result.getAuthors().isEmpty());
		assertEquals("title", result.getTitle());
	...
	public void testCreatePatent() {
		Date date = new Date();
		Patent result = factory.createPatent("title", "office", "3", "type", 
				1, date);
		assertNotNull(result.getAuthors());
		assertTrue(result.getAuthors().isEmpty());
		assertEquals("title", result.getTitle());
		...
		assertEquals(new Integer(1), result.getSequenceNumber());
	}
