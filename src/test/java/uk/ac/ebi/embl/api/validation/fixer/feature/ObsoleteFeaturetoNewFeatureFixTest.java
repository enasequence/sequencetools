...
public class ObsoleteFeaturetoNewFeatureFixTest {
  ...
  public void testCheck_withOboleteFeature2() {
    ...
    assertEquals(
        "minus_10_signal",
        feature.getSingleQualifierValue(Qualifier.REGULATORY_CLASS_QUALIFIER_NAME));
  }
