...
public class NcRNAQualifierValueAndQualifierPatternCheckTest {
  ...
  public void setUp() {
    ...
    GlobalDataSets.addTestDataSet(GlobalDataSetFile.NCRNA_QUALIFIER_VAL_QUALIFIER_PATTERN, dataRow);
  ...
  public void testCheck_Message() {
    ...
    Collection<ValidationMessage<Origin>> messages =
        result.getMessages("NcRNAQualifierValueAndQualifierPatternCheck", Severity.ERROR);
    assertEquals(
