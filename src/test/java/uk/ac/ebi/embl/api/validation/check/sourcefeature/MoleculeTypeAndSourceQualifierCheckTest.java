...
public class MoleculeTypeAndSourceQualifierCheckTest {
  ...
  public void testCheck_noSourceQualifier() {
    ...
    assertEquals(2, result.count("MoleculeTypeAndSourceQualifierCheck", Severity.ERROR));
  }
  ...
  public void testCheck_Message() {
    ...
    Collection<ValidationMessage<Origin>> messages =
        result.getMessages("MoleculeTypeAndSourceQualifierCheck", Severity.ERROR);
    assertEquals(
  ...
  public void testCheck_invalidMolTypeValue() {
    ...
    ValidationResult result = check.check(entry);
    assertEquals(
        1, result.getMessages("MoleculeTypeAndSourceQualifierCheck_1", Severity.ERROR).size());
  }
  ...
  public void testCheck_validMolTypeValue() {
    ...
    ValidationResult result = check.check(entry);
    assertEquals(
        0, result.getMessages("MoleculeTypeAndSourceQualifierCheck_1", Severity.ERROR).size());
  }
}
