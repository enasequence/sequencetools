...
public class AsciiCharacterCheckTest
{
	...
	public void testCheck_invalidDescription()
	{
		...
		entry.setDescription(new Text("ï¿½-ketothiolaseï¿½-ketothiolaseï¿½-ketothiolaseï¿½-ketothiolase"));
		ValidationResult result = check.check(entry);
		assertEquals(1, result.count("AsciiCharacterCheck_1", Severity.ERROR));
	}
	...
	public void testCheck_invalidQualifier()
	{
		...
		feature.addQualifier((new QualifierFactory()).createQualifier(Qualifier.NOTE_QUALIFIER_NAME,"ï¿½-ketothiolaseï¿½-ketothiolaseï¿½-ketothiolaseï¿½"));
	...
	{
        reference1.getPublication().setTitle("ï¿½-ketothiolaseï¿½");
