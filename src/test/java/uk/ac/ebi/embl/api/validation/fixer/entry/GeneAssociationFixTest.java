...
public class GeneAssociationFixTest {
  ...
  /**
   * does nothing as no 1 to 1 correspondence - cant decide which locus tag is the correct
   * association
   */
  @Test
  ...
  /**
   * no fix possible due to different genes being associated to two features with same locus_tags -
  ...
  /**
   * does nothing as no 1 to 1 correspondence - cant decide which psedogene is the correct
   * association
   */
  @Test
  ...
  /**
   * no fix possible due to different genes being associated to two features with same pseudogenes -
   * cant make a decision about which is correct so do nothing
   */
  @Test
