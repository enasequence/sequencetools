...
public class ExclusiveQualifierTransformToNoteQualifierFixTest {
  ...
  public void setUp() {
    ...
    DataRow dataRow1 =
        new DataRow(Qualifier.PRODUCT_QUALIFIER_NAME, Qualifier.PSEUDO_QUALIFIER_NAME);
    DataRow dataRow2 =
        new DataRow(Qualifier.PRODUCT_QUALIFIER_NAME, Qualifier.PSEUDOGENE_QUALIFIER_NAME);
    ...
    GlobalDataSets.addTestDataSet(
        GlobalDataSetFile.EXCLUSIVE_QUALIFIERS_TO_REMOVE, dataRow1, dataRow2);
  ...
  public void testCheck_noExclusiveQualifiers() {
    ...
    assertEquals(0, validationResult.count("ExclusiveQualifierToNoteQualifierFix", Severity.FIX));
  }
  ...
  public void testCheck_withExclusiveandNoteQualifiers() {
    ...
    ValidationResult validationResult = check.check(feature);
    assertEquals(
        "note1;25S rRNA", feature.getSingleQualifier(Qualifier.NOTE_QUALIFIER_NAME).getValue());
    assertEquals(
        1, validationResult.count("ExclusiveQualifierTransformToNoteQualifierFix", Severity.FIX));
  }
  ...
  public void testCheck_withExclusiveandNoNoteQualifiers() {
    ...
    feature.addQualifier(qualifier2);
    ValidationResult validationResult = check.check(feature);
    assertEquals("25S rRNA", feature.getSingleQualifier(Qualifier.NOTE_QUALIFIER_NAME).getValue());
    assertEquals(
        1, validationResult.count("ExclusiveQualifierTransformToNoteQualifierFix", Severity.FIX));
  }
}
