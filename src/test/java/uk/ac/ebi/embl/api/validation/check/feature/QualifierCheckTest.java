 ...
 */
public class QualifierCheckTest {
    ...
    public void setUp() {
        ...
        DataRow dataRow1 = new DataRow("collection_date", "N", "Y","Y","^(?:(?:(\\d{1,2})\\s*(-)){0,1}\\s*(.*)\\s*(-)){0,1}\\s*(\\d{4})$","26","(null)");
        ...
        DataSetHelper.createAndAdd(FileName.FEATURE_QUALIFIER_VALUES, dataRow1, dataRow2, dataRow3, dataRow4, dataRow5, dataRow6, dataRow7);
        DataSetHelper.createAndAdd(FileName.FEATURE_REGEX_GROUPS, regexRow,regexRow2,regexRow3,regexRow4,regexRow5,regexRow6);
    ...
    public void testCheck_InvalidArtemisKey() {
        ...
        ValidationResult result = check.check(feature);
        assertEquals(1, result.count("QualifierCheck-1", Severity.ERROR));
        assertEquals("If you are using Artemis to create this file, select the 'EMBL submission' format",
