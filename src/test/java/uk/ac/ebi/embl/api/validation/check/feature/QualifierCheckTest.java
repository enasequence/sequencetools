...
public class QualifierCheckTest {
  ...
  public void setUp() {
    ...
    DataRow dataRow8 =
        new DataRow("regulatory_class", "N", "Y", "Y", "^([\\w\\s]+)$", "108", "(null)");
    ...
    DataRow regexRow6 =
        new DataRow(
            ...
            "1",
            "TRUE",
            "other,ribozyme,snoRNA,snRNA,SRP_RNA,antisense_RNA,autocatalytically_spliced_intron,hammerhead_ribozyme,RNase_P_RNA,RNase_MRP_RNA,telomerase_RNA,guide_RNA,rasiRNA,vault_RNA,piRNA,miRNA,siRNA,scRNA,lncRNA,pre_miRNA,sgRNA,scaRNA,Y_RNA,circRNA");
    DataRow regexRow7 =
        new DataRow(
            "regulatory_class",
            "1",
