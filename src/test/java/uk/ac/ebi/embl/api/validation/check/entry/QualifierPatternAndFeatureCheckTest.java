...
public class QualifierPatternAndFeatureCheckTest {
  ...
  public void setUp() {
    ...
    DataRow qualifier_pattern_feature_row1 =
        new DataRow("rRNA", "product", "^(28S ribsoomal RNA-).*$");
    DataRow qualifier_pattern_feature_row2 = new DataRow("tRNA", "product", "^(transfer RNA-).*$");

    entry = entryFactory.createEntry();
    GlobalDataSets.addTestDataSet(
        GlobalDataSetFile.QUALIFIER_PATTERN_FEATURE,
        qualifier_pattern_feature_row1,
        qualifier_pattern_feature_row2);
