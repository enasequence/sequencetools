...
public class SequenceAccessionTest {
  ...
  public void testCreation() {
    ...
    assertEquals(Integer.valueOf(3), id.getVersion());
  ...
  public void testParseAccession() {
    assertEquals("BN00001", SequenceAccession.parseAccession("BN00001.3"));
  }

  @Test
  public void testParseAccession_WrongVersion() {
    assertEquals("BN00001", SequenceAccession.parseAccession("BN00001.x3"));
  }
  ...
  public void testParseVersion() {
    assertEquals(Integer.valueOf(3), SequenceAccession.parseVersion("B001.3"));
    assertEquals(Integer.valueOf(3), SequenceAccession.parseVersion(".3"));
  }
  ...
  public void testCompareTo() {
    assertEquals(0, new SequenceAccession("B001", 3).compareTo(new SequenceAccession("B001", 3)));

    assertEquals(-1, new SequenceAccession("A001", 3).compareTo(new SequenceAccession("B001", 3)));
    assertEquals(1, new SequenceAccession("B001", 3).compareTo(new SequenceAccession("A001", 3)));

    assertEquals(-1, new SequenceAccession("B001", 1).compareTo(new SequenceAccession("B001", 3)));
    assertEquals(1, new SequenceAccession("B001", 5).compareTo(new SequenceAccession("A001", 3)));

    assertEquals(-1, new SequenceAccession("A001", 1).compareTo(new SequenceAccession("B001", 3)));
    assertEquals(-1, new SequenceAccession("A001", 5).compareTo(new SequenceAccession("B001", 3)));
    assertEquals(1, new SequenceAccession("C001", 1).compareTo(new SequenceAccession("B001", 3)));
    assertEquals(1, new SequenceAccession("C001", 5).compareTo(new SequenceAccession("B001", 3)));
  }
}
