...
public class CdsFeatureTest {
  ...
  public void testGetTranslation() {
    ...
    cdsFeature.addQualifier(factory.createQualifier(Qualifier.TRANSLATION_QUALIFIER_NAME, "ttt"));
  ...
  public void testSetTranslation() {
    assertNull(cdsFeature.getTranslation());
    assertTrue(cdsFeature.getQualifiers(Qualifier.TRANSLATION_QUALIFIER_NAME).isEmpty());

    cdsFeature.setTranslation("trans");

    assertEquals("trans", cdsFeature.getTranslation());
    assertEquals(1, cdsFeature.getQualifiers(Qualifier.TRANSLATION_QUALIFIER_NAME).size());
    assertEquals("trans", cdsFeature.getSingleQualifierValue(Qualifier.TRANSLATION_QUALIFIER_NAME));
    ...
    assertEquals(1, cdsFeature.getQualifiers(Qualifier.TRANSLATION_QUALIFIER_NAME).size());
    assertEquals(
        "trans2", cdsFeature.getSingleQualifierValue(Qualifier.TRANSLATION_QUALIFIER_NAME));
  }
  ...
  public void testSetProteinAccession() throws ValidationException {
    assertNull(cdsFeature.getProteinAccession());
    assertTrue(cdsFeature.getQualifiers(Qualifier.PROTEIN_ID_QUALIFIER_NAME).isEmpty());

    cdsFeature.setSingleQualifierValue(Qualifier.PROTEIN_ID_QUALIFIER_NAME, "BAA00001.1");

    assertEquals("BAA00001", cdsFeature.getProteinAccession());
    assertEquals(1, cdsFeature.getQualifiers(Qualifier.PROTEIN_ID_QUALIFIER_NAME).size());
    assertEquals(
        "BAA00001.1", cdsFeature.getSingleQualifierValue(Qualifier.PROTEIN_ID_QUALIFIER_NAME));

    cdsFeature.setSingleQualifierValue(Qualifier.PROTEIN_ID_QUALIFIER_NAME, "BAA00012.1");

    assertEquals("BAA00012", cdsFeature.getProteinAccession());
    assertEquals(1, cdsFeature.getQualifiers(Qualifier.PROTEIN_ID_QUALIFIER_NAME).size());
    assertEquals(
        "BAA00012.1", cdsFeature.getSingleQualifierValue(Qualifier.PROTEIN_ID_QUALIFIER_NAME));
  }
  ...
  public void testGetProteinVersion() throws ValidationException {
    ...
    assertEquals(Integer.valueOf(3), cdsFeature.getProteinVersion());
  }
  ...
  public void testSetProteinVersion() throws ValidationException {
    ...
    assertEquals(Integer.valueOf(1), cdsFeature.getProteinVersion());
    assertEquals(1, cdsFeature.getQualifiers(Qualifier.PROTEIN_ID_QUALIFIER_NAME).size());
    assertEquals(
        "BAA00001.1", cdsFeature.getSingleQualifierValue(Qualifier.PROTEIN_ID_QUALIFIER_NAME));

    cdsFeature.setSingleQualifierValue(Qualifier.PROTEIN_ID_QUALIFIER_NAME, "BAA00001.2");

    assertEquals(Integer.valueOf(2), cdsFeature.getProteinVersion());
    assertEquals(1, cdsFeature.getQualifiers(Qualifier.PROTEIN_ID_QUALIFIER_NAME).size());
    assertEquals(
        "BAA00001.2", cdsFeature.getSingleQualifierValue(Qualifier.PROTEIN_ID_QUALIFIER_NAME));
  }
  ...
  public void testCodonStart() throws ValidationException {
    ...
    assertEquals(Integer.valueOf(1), cdsFeature.getStartCodon());
    cdsFeature.setStartCodon(2);
    assertEquals(Integer.valueOf(2), cdsFeature.getStartCodon());
  ...
  public void testTranslationTable() throws ValidationException {
    ...
    assertEquals(Integer.valueOf(1), cdsFeature.getTranslationTable());
    cdsFeature.setTranslationTable(2);
    assertEquals(Integer.valueOf(2), cdsFeature.getTranslationTable());
