...
public class EntryMolTypeCheckTest {
  ...
  public void setUp() {
    ...
    DataRow regexRow =
        new DataRow(
            ...
            "1",
            "TRUE",
            "genomic RNA,viral cRNA,other DNA,other RNA,pre-RNA,transcribed RNA,genomic DNA,unassigned RNA,unassigned DNA");
  ...
  public void testCheck_Message() {
    ...
    assertEquals(
        ...
        validationResult.getMessages().iterator().next().getMessage());
  }
}
