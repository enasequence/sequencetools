...
public class LocusTagAssociationFixTest {
    ...
    /**
     * no fix possible due to different locus tags being associated to two features with same gene - cant make a
    ...
    public void testCheck_BadLocusTagAssociation() {
        ...
        feature2.addQualifier(qualifierFactory.createQualifier(Qualifier.LOCUS_TAG_QUALIFIER_NAME,"pod"));
        entry.addFeature(feature2);
    ...
    public void testFix_LocusTagAssociation() {
        ...
        Qualifier addedQualifier = SequenceEntryUtils.getQualifier(Qualifier.LOCUS_TAG_QUALIFIER_NAME, feature);
