...
public class PCRPrimersQualifierCheckTest {
  ...
  public void setUp() {
    ...
    qualifier = qualifierFactory.createQualifier(Qualifier.PCR_PRIMERS_QUALIFIER_NAME);
  ...
  public void testCheck_valid() {
    qualifier.setValue(
        "fwd_name: H1594(Cpn60)+M13(-40F), fwd_seq:gaggtcgccggtgacggcaccaccac, rev_name:H1595(Cpn60)+M13(48R), rev_seq: cgacggtcgccgaagcccggggcctt");
    ValidationResult validationResult = check.check(feature);
    assertEquals(0, validationResult.count("PCRPrimersQualifierCheck_2", Severity.ERROR));
    assertEquals(0, validationResult.count("PCRPrimersQualifierCheck_3", Severity.ERROR));
