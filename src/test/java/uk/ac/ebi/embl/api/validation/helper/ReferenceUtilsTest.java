...
public class ReferenceUtilsTest {
  ...
  public void testConstructReferenceWithoutConsortiumAndBroker()
    ...
    SubmitterReference submitterReference =
        new SubmitterReference(submissionContactList, submissionAccount);
    ...
    assertEquals(
        "EBI.(EBL-EBI), EBI Lab, Hinxton, Cambridgeshire, United Kingdom",
        ((Submission) reference.getPublication()).getSubmitterAddress());
  ...
  public void testConstructReferenceWithConsortiumAndBroker()
    ...
    assertEquals(
        "AB bioinformatics, Hinxton, Cambridgeshire, United Kingdom",
        ((Submission) reference.getPublication()).getSubmitterAddress());
  ...
  public void testGetSubmitterReferenceFromManifest() throws ValidationEngineException {
    ...
    Reference reference =
        refutils.getSubmitterReferenceFromManifest(authors, address, date, submissionAccountId);
    assertNotNull(reference);
  ...
  public void testGetSubmitterReferenceFromManifestAddAuthorstoCosortium()
    ...
    ReferenceUtils referenceUtilsMock =
        EasyMock.partialMockBuilder(ReferenceUtils.class)
            .addMockedMethod("doAddAuthorsToConsortium")
            .createMock();
    ...
    Reference reference =
        referenceUtilsMock.getSubmitterReferenceFromManifest(
            authors, address, date, submissionAccountId);
    assertNotNull(reference);
    assertEquals(address, ((Submission) reference.getPublication()).getSubmitterAddress());
