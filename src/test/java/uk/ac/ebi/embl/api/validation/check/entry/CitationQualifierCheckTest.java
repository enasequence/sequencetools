...
public class CitationQualifierCheckTest {
  ...
  public void setUp() {
    ...
    Qualifier citationQualifier =
        qualifierFactory.createQualifier(Qualifier.CITATION_QUALIFIER_NAME, "1");
    ...
    Submission submission =
        (new ReferenceFactory()).createSubmission(referenceFactory.createPublication());
  ...
  public void testChecknoReferenceswithCitationQualifier() {
    ...
    assertEquals(
        ...
        validationResult.count(
            CitationQualifierCheck.CITATION_QUALIFIER_MESSAGE_ID, Severity.ERROR));
  }
  ...
  public void testCheckInvalidCitationQualifier() {
    ...
    entry.addReference(reference);
    Qualifier citationQualifier =
        qualifierFactory.createQualifier(Qualifier.CITATION_QUALIFIER_NAME, "2");
    feature.addQualifier(citationQualifier);
    entry.addFeature(feature);
    ValidationResult validationResult = check.check(entry);
    assertTrue(!validationResult.isValid());
