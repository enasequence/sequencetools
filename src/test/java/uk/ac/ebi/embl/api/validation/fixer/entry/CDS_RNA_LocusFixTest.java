...
public class CDS_RNA_LocusFixTest {
  ...
  public void testCheck_Empty() {
    ...
    assertTrue(
        result.getMessages(Severity.FIX).isEmpty()); // dont make a fuss, other checks for that
  }
  ...
  @Test
  public void
      testCheck_GeneOverlapNoLack() { // i.e. the required qualifier is preset so no need to inherit
    Feature cdsFeature = featureFactory.createFeature("CDS");
    /**
