...
public class EntryTest {
  ...
  public void testRemoveFeature() {
    Feature feature = new FeatureFactory().createFeature("feature", false);
  ...
  public void testRemoveReference() {
    ...
    Reference refX = factory.createReference(factory.createArticle("x", "j"), 1);
    Reference refY = factory.createReference(factory.createArticle("y", "j"), 1);
  ...
  public void testRemoveAssembly() {
    Assembly assemblyX = new EntryFactory().createAssembly("x", 1, 1L, 3L, false, 2L, 4L);
    Assembly assemblyY = new EntryFactory().createAssembly("y", 1, 1L, 3L, false, 2L, 4L);
