...
import uk.ac.ebi.embl.flatfile.reader.embl.COReader;

public class COReaderTest extends EmblReaderTest {

	public void testRead() throws IOException {
		initLineReader(
			"CO   join(AL358912.1:1..39187,\n" +
			"CO   gap(unk100),gap(43),complement(AAOX01000077.1:1..2879))\n"
		);
		ValidationResult result = (new COReader(lineReader)).read(entry);
