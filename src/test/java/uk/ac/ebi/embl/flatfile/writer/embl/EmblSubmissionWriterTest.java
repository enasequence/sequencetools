...
public class EmblSubmissionWriterTest extends EmblWriterTest {
  ...
  public void testWrite_Submission() throws IOException {
    ...
    assertTrue(new RLWriter(entry, submission, wrapType).write(writer));
    // System.out.print(writer.toString());
    assertEquals(
        "RL   Submitted (10-SEP-1998) to the INSDC.\n"
  ...
  public void testWrite_EmptySubmission() throws IOException {
    ...
    assertTrue(new RLWriter(entry, submission, wrapType).write(writer));
    // System.out.print(writer.toString());
    assertEquals("RL   Submitted () to the INSDC.\n", writer.toString());
  }
}
