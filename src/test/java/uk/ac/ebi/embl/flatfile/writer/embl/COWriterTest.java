...
import uk.ac.ebi.embl.flatfile.writer.embl.COWriter;
...
public class COWriterTest extends EmblWriterTest {
	...
	public void testWrite_Contigs() throws IOException {
		...
		entry.getSequence().addContig(
				locationFactory.createRemoteBase("A00001", 1, 1l));
		...
		assertEquals(
				"CO   join(A00001.1:1..1,gap(unk100),gap(100),A00001.1:1..210,A00001.1:1..210,\n" +
