...
public class EmblQualifierWriterTest extends EmblWriterTest {
  ...
  public void testWrite_Break() throws IOException {
    ...
    for (Qualifier qualifier : feature.getQualifiers()) {
      assertTrue(
          new QualifierWriter(entry, qualifier, wrapType, EmblPadding.QUALIFIER_PADDING)
              .write(writer));
    }
  ...
  public void testWrite_NoQualifiers() throws IOException {
    StringWriter writer = new StringWriter();
    assertFalse(
        new QualifierWriter(entry, null, wrapType, EmblPadding.QUALIFIER_PADDING).write(writer));
    // System.out.print(writer.toString());
