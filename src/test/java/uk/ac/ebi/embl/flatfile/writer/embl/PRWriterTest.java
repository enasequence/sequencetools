...
public class PRWriterTest extends EmblWriterTest {
  ...
  public void testWrite_TwoProjects() throws IOException {
    ...
    assertTrue(new PRWriter(entry, wrapType).write(writer));
    // System.out.print(writer.toString());
    assertEquals("PR   Project:17285; Project:123456;\n", writer.toString());
  }

  public void testWrite_ManyProjects() throws IOException {
    entry.addProjectAccessions(
        Arrays.asList(
            new Text("17285"),
            new Text("123456"),
            new Text("17285"),
    ...
    // System.out.print(writer.toString());
    assertEquals(
        "PR   Project:17285; Project:123456; Project:17285; Project:123456;\n"
            + "PR   Project:17285; Project:123456; Project:17285; Project:123456;\n"
            + "PR   Project:17285; Project:123456;\n",
        writer.toString());
  }
}
