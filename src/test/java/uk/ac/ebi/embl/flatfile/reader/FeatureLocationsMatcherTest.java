...
public class FeatureLocationsMatcherTest extends TestCase {
    ...
    public void testLocation() {
        ...
        assertEquals(true, leftPartial(location));
        assertEquals(false, rightPartial(location));

        location = "complement(<2807037..2807081)";
        assertEquals(location, test(location));
        assertEquals(false, leftPartial(location));
        assertEquals(true, rightPartial(location));
