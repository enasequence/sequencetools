...
public class GFF3Writer {
  ...
  public static void writeRegionPragma(Writer writer, String accession, Long beginPos, Long endPos)
      throws IOException {
  ...
  public static void writeAttribute(Writer writer, String tag, String value) throws IOException {
    writer.write(tag);
    writer.write("=");
    writer.write(value);
  }
  ...
  private static void writeStrandColumn(Writer writer, Boolean isComplement) throws IOException {
    ...
    } else if (isComplement) writeColumn(writer, "+");
    else writeColumn(writer, "-");
  }
  ...
  public static void writeColumns(
      ...
      throws IOException {
    writeColumns(writer, accession, type, beginPosition, endPosition, isComplement, null);
  }

  public static void writeColumns(
      Writer writer, String accession, String type, Long beginPosition, Long endPosition)
      throws IOException {
    writeColumns(writer, accession, type, beginPosition, endPosition, null, null);
  }
