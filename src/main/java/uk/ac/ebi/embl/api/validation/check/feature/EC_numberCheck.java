...
public class EC_numberCheck extends FeatureValidationCheck {
  ...
  public ValidationResult check(Feature feature) throws ValidationEngineException {
    ...
    try {
      ...
      String ecNumberValue =
          SequenceEntryUtils.getQualifierValue(Qualifier.EC_NUMBER_QUALIFIER_NAME, feature);
      String result = getEntryDAOUtils().isEcnumberValid(ecNumberValue);

      if (result == null) reportError(feature.getOrigin(), EC_numberCheck_Error_ID, ecNumberValue);
      if ("N".equals(result))
