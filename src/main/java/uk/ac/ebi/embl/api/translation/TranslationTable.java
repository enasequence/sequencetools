...
/** NCBI translation table. Bases are encoded using lower case single letter 
 * JCBN abbreviations and amino acids are encoded using upper case single 
 * letter JCBN abbreviations.
 */
public class TranslationTable {

    /** Constructs the translation table.
     */
    protected TranslationTable(Integer number, String name,
    ...
    public final static Integer DEFAULT_TRANSLATION_TABLE = 11;
    public final static Integer PLASTID_TRANSLATION_TABLE = 11;
