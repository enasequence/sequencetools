...
@Description(
    "Feature qualifier \"{0}\" has invalid date i.e.{1}"
...
public class CollectionDateQualifierCheck extends FeatureValidationCheck {
  ...
  public static final String INSDC_DATE_FORMAT_1 = "dd-MMM-yyyy"; // dd-MMM-yyyy
  public static final String INSDC_DATE_FORMAT_2 = "MMM-yyyy"; // MMM-yyyy
  public static final String ISO_DATE_FORMAT_1 = "yyyy"; // yyyy
  public static final String ISO_DATE_FORMAT_2 = "yyyy-MM"; // yyyy-MM
  public static final String ISO_DATE_FORMAT_3 = "yyyy-MM-dd"; // yyyy-MM-dd
  public static final String ISO_DATE_FORMAT_4 = "yyyy-MM-dd'T'HH'Z'"; // yyyy-MM-ddThhZ
  public static final String ISO_DATE_FORMAT_5 = "yyyy-MM-dd'T'HH:mm'Z'"; // yyyy-MM-ddThh:mmZ
  public static final String ISO_DATE_FORMAT_6 = "yyyy-MM-dd'T'HH:mm:ss'Z'"; // yyyy-MM-ddThh:mmZ

  private static final DateTimeFormatter INSDC_DATE_FORMATTER_1 =
      formatter(INSDC_DATE_FORMAT_1); // dd-MMM-yyyy
  private static final DateTimeFormatter INSDC_DATE_FORMATTER_2 =
      formatter(INSDC_DATE_FORMAT_2); // MMM-yyyy
  private static final DateTimeFormatter ISO_DATE_FORMATTER_1 =
      formatter(ISO_DATE_FORMAT_1); // yyyy
  private static final DateTimeFormatter ISO_DATE_FORMATTER_2 =
      formatter(ISO_DATE_FORMAT_2); // yyyy-MM
  private static final DateTimeFormatter ISO_DATE_FORMATTER_3 =
      formatter(ISO_DATE_FORMAT_3); // yyyy-MM-dd
  private static final DateTimeFormatter ISO_DATE_FORMATTER_4 =
      formatter(ISO_DATE_FORMAT_4); // yyyy-MM-ddThhZ
  private static final DateTimeFormatter ISO_DATE_FORMATTER_5 =
      formatter(ISO_DATE_FORMAT_5); // yyyy-MM-ddThh:mmZ
  private static final DateTimeFormatter ISO_DATE_FORMATTER_6 =
      formatter(ISO_DATE_FORMAT_6); // yyyy-MM-ddThh:mmZ
  ...
  static final int DEFAULT_HOUR = 0;
  ...
  public ValidationResult check(Feature feature) {
    ...
    for (Qualifier collectionQualifier : collectionDateQualifiers) {
      ...
      if (isValueEmpty(value)) {
        reportError(
            collectionQualifier.getOrigin(), DATE_FORMAT_ERROR, collectionQualifier.getName(), "");
        continue;
      }
      ...
      try {
        if (!isValidDate(value)) {
          reportError(
              collectionQualifier.getOrigin(),
              DATE_FORMAT_ERROR,
              collectionQualifier.getName(),
              value);
        } else {
