...
public class QualifierValueNotQualifierEntryCheck extends EntryValidationCheck {
  ...
  private static final String MESSAGE_ID = "QualifierValueNotQualifierEntryCheck";
  ...
  public ValidationResult check(Entry entry) {
    ...
    DataSet dataSet =
        GlobalDataSets.getDataSet(GlobalDataSetFile.QUALIFIER_VALUE_NOT_QUALIFIER_ENTRY);
        ...
        for (Qualifier qualifier : qualifiers) {
          ...
          if (qualifier != null
            ...
            for (Feature featureq : entry.getFeatures()) {
              if (!SequenceEntryUtils.isQualifierAvailable(notPermittedQualifierName, featureq)) {
                continue;
              }
              reportError(
                  featureq.getOrigin(),
                  MESSAGE_ID,
                  notPermittedQualifierName,
                  qualifierName,
                  qualifierValue);
            }
          }
