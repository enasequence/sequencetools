...
public class GeneAssociatedwithFeatureFix extends EntryValidationCheck {
  ...
  public ValidationResult check(Entry entry) {
    ...
    if (cdsFeatures.size() != 0) geneAssociatedFeatures.addAll(cdsFeatures);
    if (trnaFeatures.size() != 0) geneAssociatedFeatures.addAll(trnaFeatures);
    if (rrnaFeatures.size() != 0) geneAssociatedFeatures.addAll(rrnaFeatures);
