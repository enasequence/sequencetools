...
@Description(
    "isolation_source qualifier transformed to country qualifier as isolation_source qualifier value \"{0}\", is country"
        + "isolation_source qualifier transformed to lat_lon qualifier as isolation_source qualifier value \"{0}\", matches lat_lon regex")
public class Isolation_sourceQualifierFix extends FeatureValidationCheck {
  private static final String ISOLATION_SOURCE_COUNTRY_FIX_ID = "Isolation_sourceQualifierFix_1";
  private static final String ISOLATION_SOURCE_LAT_LON_FIX_ID = "Isolation_sourceQualifierFix_2";
  ...
  public ValidationResult check(Feature feature) {
    ...
    DataSet qualifierRegexSet =
        GlobalDataSets.getDataSet(GlobalDataSetFile.FEATURE_QUALIFIER_VALUES);
    ...
    List<Qualifier> isolation_sourceQualifiers =
        feature.getQualifiers(Qualifier.ISOLATION_SOURCE_QUALIFIER_NAME);
      ...
      if (isolationQualifierValue != null) {
        ...
        if (countryPattern != null
          ...
          reportMessage(
              Severity.FIX,
              feature.getOrigin(),
              ISOLATION_SOURCE_COUNTRY_FIX_ID,
              isolationQualifierValue);
          ...
          if (lat_lonPattern.matcher(isolationQualifierValue).matches()) {
            ...
            reportMessage(
                Severity.FIX,
                feature.getOrigin(),
                ISOLATION_SOURCE_LAT_LON_FIX_ID,
                isolationQualifierValue);
          }
        }
      }
