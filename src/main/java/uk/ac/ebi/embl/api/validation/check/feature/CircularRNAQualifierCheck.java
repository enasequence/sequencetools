...
@Description("Qualifier circularRNA is not allowed in feature {0},  only CDS,mRNA or tRNA feature can contain circularRNA qualifier.")
public class CircularRNAQualifierCheck extends FeatureValidationCheck {
    ...
    public ValidationResult check(Feature feature) {
        ...
        if(cirularRNAQual != null && !feature.getName().equals(Feature.CDS_FEATURE_NAME)
