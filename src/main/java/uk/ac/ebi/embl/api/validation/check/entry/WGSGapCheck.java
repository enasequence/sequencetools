...
public class WGSGapCheck extends EntryValidationCheck {
  ...
  public ValidationResult check(Entry entry) {
    ...
    if (dataclass != null && dataclass.equals(Entry.WGS_DATACLASS)) {
      ...
      if (SequenceEntryUtils.isFeatureAvailable(Feature.GAP_FEATURE_NAME, entry)
          || SequenceEntryUtils.isFeatureAvailable(Feature.ASSEMBLY_GAP_FEATURE_NAME, entry)) {
        ...
        ValidationMessage<Origin> message = reportWarning(null, GAPS_PRESENT_ID);
