...
public class QualifierValueNotQualifierCheck extends FeatureValidationCheck {
  ...
  private static final String MESSAGE_ID = "QualifierValueNotQualifierCheck";

  public QualifierValueNotQualifierCheck() {}

  public ValidationResult check(Feature feature) {
    DataSet dataSet = GlobalDataSets.getDataSet(GlobalDataSetFile.QUALIFIER_VALUE_NOT_QUALIFIER);
