...
public class ValidationMessageManager {
  ...
  public static final String STANDARD_VALIDATION_BUNDLE =
      "uk.ac.ebi.embl.api.validation.ValidationMessages";
  public static final String STANDARD_FIXER_BUNDLE = "uk.ac.ebi.embl.api.validation.FixerMessages";

  public static final String GFF3_VALIDATION_BUNDLE =
  ...
  private static final List<ResourceBundle> bundles = new Vector<ResourceBundle>();
  private static final Set<String> bundleNames = Collections.synchronizedSet(new HashSet<String>());
