...
@Description(
    "Feature qualifier \\\"{0}\\\" is not recognized\\Feature qualifier \\\"{0}\\\" does not have a value (mandatory for this type)\\"
  ...
  public ValidationResult check(Feature feature) {
    ...
    try {
      if (feature instanceof SourceFeature
          && (ValidationScope.ASSEMBLY_CHROMOSOME.equals(
                  getEmblEntryValidationPlanProperty().validationScope.get())
              || ValidationScope.ASSEMBLY_CONTIG.equals(
                  getEmblEntryValidationPlanProperty().validationScope.get())
              || ValidationScope.ASSEMBLY_SCAFFOLD.equals(
                  getEmblEntryValidationPlanProperty().validationScope.get()))) return result;
      ...
      QualifierHelper.QualifierInfo qInfo =
          qualifierMap.get(Qualifier.COLLECTION_DATE_QUALIFIER_NAME);
      ...
      for (Qualifier qualifier : feature.getQualifiers()) {
        ...
        if (qualifierMap.containsKey(qualifierName)) {
          ...
          QualifierHelper.checkNoValue(qualifier, qualifierInfo.isNoValue(), feature.getName())
      ...
      throw new IllegalArgumentException(
          "Invalid pattern while instantiating QualifierCheck! " + e.getMessage());
