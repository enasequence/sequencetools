...
public class Tag_PeptideQualifier extends Qualifier implements Serializable, LocationQualifier {
  ...
  public Tag_PeptideQualifier(String value) {
    super(TAG_PEPTIDE_QUALIFIER_NAME, value);
  }
  ...
  public boolean setLocation(Location location) throws ValidationException {
    ...
    String newTagPeptideValue =
        matcher.replaceFirst(
            location.getBeginPosition().toString() + "$2" + location.getEndPosition().toString());
    setValue(newTagPeptideValue);
    // System.out.println(newTagPeptideValue);
    return true;
  }
}
