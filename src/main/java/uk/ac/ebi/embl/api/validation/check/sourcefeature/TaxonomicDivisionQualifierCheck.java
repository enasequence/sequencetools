...
public class TaxonomicDivisionQualifierCheck extends EntryValidationCheck {
  private static final String TAXONOMIC_DIVISION_MESSAGE_ID = "TaxonomicDivisionQualifierCheck_1";
  ...
  public ValidationResult check(Entry entry) {
    ...
    for (DataRow dataRow : dataSet.getRows()) {
      ...
      if (SequenceEntryUtils.isQualifierAvailable(qualifier, entry)
          && !divisions.contains(taxon.getDivision())) {
