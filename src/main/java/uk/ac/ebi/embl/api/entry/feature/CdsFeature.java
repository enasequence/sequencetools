...
public class CdsFeature extends Feature implements Serializable {
  ...
  public String getProteinAccession() throws ValidationException {
    ProteinIdQualifier qualifier =
        (ProteinIdQualifier) getSingleQualifier(Qualifier.PROTEIN_ID_QUALIFIER_NAME);
    if (qualifier == null) {
      return null;
    }
  ...
  public Integer getTranslationTable() throws ValidationException {
    TranslTableQualifier qualifier =
        (TranslTableQualifier) getSingleQualifier(Qualifier.TRANSL_TABLE_QUALIFIER_NAME);
    if (qualifier == null) {
      return null;
    }
  ...
  public Integer getStartCodon() throws ValidationException {
    CodonStartQualifier qualifier =
        (CodonStartQualifier) getSingleQualifier(Qualifier.CODON_START_QUALIFIER_NAME);
    if (qualifier == null) {
      return null;
    }
  ...
  public boolean isPseudo() {
    return (getSingleQualifier(Qualifier.PSEUDO_QUALIFIER_NAME) != null
        || getSingleQualifier(Qualifier.PSEUDOGENE_QUALIFIER_NAME) != null);
  }
