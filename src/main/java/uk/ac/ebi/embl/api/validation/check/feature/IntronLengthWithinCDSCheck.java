...
public class IntronLengthWithinCDSCheck extends FeatureValidationCheck {
  ...
  public ValidationResult check(Feature feature) {
    ...
    if (feature instanceof CdsFeature) {
      ...
      boolean hasArtificialLocation =
          SequenceEntryUtils.isQualifierAvailable(Qualifier.ARTIFICIAL_LOCATION, cdsFeature);
      boolean hasribosomal_slippage =
          SequenceEntryUtils.isQualifierAvailable(
              Qualifier.RIBOSOMAL_SLIPPAGE_QUALIFIER_NAME, cdsFeature);
      boolean hastrans_splicing =
          SequenceEntryUtils.isQualifierAvailable(Qualifier.TRANS_SPLICING, cdsFeature);
