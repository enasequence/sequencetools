  ...
  public ValidationResult check(Entry entry) throws ValidationEngineException {
    ...
    for (Feature feature : entry.getFeatures()) {
      ...
      if (feature.getQualifiers(Qualifier.PROTEIN_ID_QUALIFIER_NAME) != null
          & feature.getQualifiers(Qualifier.PROTEIN_ID_QUALIFIER_NAME).size() != 0) {
        List<Qualifier> protein_idQualifiers =
            feature.getQualifiers(Qualifier.PROTEIN_ID_QUALIFIER_NAME);
