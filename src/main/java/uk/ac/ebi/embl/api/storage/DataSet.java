...
public class DataSet {
	...
	/**
	 * Checks whether data set contains a row which values of specified column
	 * equals to provided value. 
	 * 
	 * @param columnIndex a number of column
	 * @param value a value to be compared
	 * @return true if data set contains a row with provided value in specified 
	 * column 
	 */
