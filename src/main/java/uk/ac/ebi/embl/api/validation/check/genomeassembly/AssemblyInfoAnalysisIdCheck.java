...
public class AssemblyInfoAnalysisIdCheck extends GenomeAssemblyValidationCheck<AssemblyInfoEntry> {
  ...
  public static final String MESSAGE_KEY_MISSING_ANALYSIS_ID_ERROR =
      "AssemblyInfoMissingAnalysisIDCheck";
  public static final String MESSAGE_KEY_INVALID_ANALYSIS_ID_ERROR =
      "AssemblyInfoInvalidAnalysisIDCheck";
