...
public class LocationFactory {
	...
	public LocalRange createLocalRange(
			Long beginPosition, Long endPosition, boolean complement) {
	...
	public LocalBetween createLocalBetween(
				Long beginPosition,	Long endPosition) {
		return new LocalBetween(beginPosition, endPosition);
	}
	
	public RemoteRange createRemoteRange(String accession, 
			Integer version, Long beginPosition, Long endPosition) {
	...
	public RemoteBase createRemoteBase(String accession,
			Integer version, Long position) {
		return new RemoteBase(accession, version, position);
	}

	public RemoteBase createRemoteBase(String accession,
			Integer version, Long position, boolean complement) {
		return new RemoteBase(accession, version, position, complement);
	}
	
	public RemoteBetween createRemoteBetween(String accession, 
			Integer version, Long beginPosition, Long endPosition) {
