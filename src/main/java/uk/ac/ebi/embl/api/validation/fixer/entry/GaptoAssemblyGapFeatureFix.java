...
@Description(
    "Gap features replaced with assembly_gap features as entry has assembly_gap and gap features and gap/assembly_gap features are mutually exclusive")
public class GaptoAssemblyGapFeatureFix extends EntryValidationCheck {
  ...
  public ValidationResult check(Entry entry) {
    ...
    List<Feature> gapFeautures = SequenceEntryUtils.getFeatures(Feature.GAP_FEATURE_NAME, entry);
