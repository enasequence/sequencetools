...
@Description(
    "Qualifier {0} must not have value which matches the pattern {1} + <value> + {2} where <value> is a value of qualifier {3}.")
...
public class QualifierValueNotQualifierPatternCheck extends FeatureValidationCheck {
  ...
  public ValidationResult check(Feature feature) {
    DataSet dataSet =
        GlobalDataSets.getDataSet(GlobalDataSetFile.QUALIFIER_VALUE_NOT_QUALIFIER_PATTERN);
