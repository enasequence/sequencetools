...
public abstract class AbstractTranslator {
  ...
  public abstract ExtendedResult<TranslationResult> translate(byte[] sequence, Origin origin);

  protected abstract void translateCodons(byte[] sequence, TranslationResult translationResult)
