...
/** Validator for Sample_id column values. Rule: Only alphabet letters and numbers are allowed. */
public class SampleIdValidator implements ColumnValidator {

  private static final String COLUMN_NAME = "Sample_id";
  ...
  public ValidationResult validate(String value, int rowNumber, int columnIndex) {
    ...
    // hyphen, dot)
    // Allow alphanumeric plus underscore, hyphen, and dot which are common in sample IDs
