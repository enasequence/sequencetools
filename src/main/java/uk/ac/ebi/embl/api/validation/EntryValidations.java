...
public class EntryValidations {
	 ...
	 */
	public static ValidationMessage<Origin> createMessage(Origin origin, Severity severity,
	 ...
	 * @return a validation message
	 */
//	public static ValidationMessage<Origin> createMessage(Collection<Origin> origins, Severity severity,
//                                                          String messageKey, Object... params) {
