...
public class LocationStringParser {
  ...
  public CompoundLocation<Location> getCompoundLocation(String locationString, boolean ignoreError)
  ...
  public Location getLocation(String locationString) throws ValidationException {
    ...
    if (operator == null) {
      if (accession != null) {
        ...
        location =
            locationFactory.createLocalBase(
                getLong(rightPartial ? GROUP_END_POSITION : GROUP_BEGIN_POSITION));
      }
    ...
    if (obj instanceof Qualifier) {
      throw new ValidationException(
          ValidationMessage.error(
                  "Qualifier", ((Qualifier) obj).getName(), ((Qualifier) obj).getValue())
              .append(((Qualifier) obj).getOrigin()));
    } else if (obj instanceof Feature) {
      throw new ValidationException(
          ValidationMessage.error(
              "Feature", ((Feature) obj).getName(), ((Feature) obj).getOrigin()));
    }
  }
}
