...
public class ReferenceFactory {
  ...
  public Reference createReference(Publication publication, Integer referenceNumber) {
  ...
  public LocalRange createRange(Long beginPosition, Long endPosition) {
    LocationFactory locationFactory = new LocationFactory();
    return locationFactory.createLocalRange(beginPosition, endPosition);
  }
  ...
  public Book createBook(
      String title, String bookTitle, String firstPage, String lastPage, String publisher) {
  ...
  public ElectronicReference createElectronicReference(String title, String text) {
  ...
  public Submission createSubmission(String title, Date day, String submitterAddress) {
  ...
  public Patent createPatent(
      ...
      Date day) {
    return new Patent(title, patentOffice, patentNumber, patentType, sequenceNumber, day);
  }
