...
@ExcludeScope(validationScope={ValidationScope.EMBL_TEMPLATE, ValidationScope.NCBI,ValidationScope.ASSEMBLY_TRANSCRIPTOME, ValidationScope.NCBI_MASTER})//do not run in template mode - no ability to add gaps
