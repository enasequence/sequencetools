...
public class EmblOrganismWriter extends FlatFileWriter {
  ...
  public boolean write(Writer writer) throws IOException {
    ...
    writeBlock |= new OSWriter(entry, sourceFeature, wrapType).write(writer);
    writeBlock |= new OCWriter(entry, sourceFeature, wrapType).write(writer);
    writeBlock |= new OGWriter(entry, sourceFeature, wrapType).write(writer);
    return writeBlock;
  }
}
