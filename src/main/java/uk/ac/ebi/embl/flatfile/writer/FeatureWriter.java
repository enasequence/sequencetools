...
public class FeatureWriter extends FlatFileWriter {
	...
	//TODO: return value?    
    public boolean 
    write( Writer writer ) throws IOException 
    {
    ...
    protected void writeFeatureQualifiers(Writer writer) throws IOException {
        ...
        for (Qualifier qualifier : qualifiers) {
			new QualifierWriter(entry, qualifier, wrapType,
	        		qualifierHeader).write(writer);        
	    }
    }
}
