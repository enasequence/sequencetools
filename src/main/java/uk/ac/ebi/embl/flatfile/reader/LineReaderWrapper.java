...
/**
 * Wraps a BufferedReader, RandomAccessFile or ILineReader so that readLine() may be called without
 * knowing underlying implementation. Modified so that seek() and getFilePointer() may also be
 * called assuming that the other file reader implements these.
 *
 * @author simonk
 */
public class LineReaderWrapper implements ILineReader {
   ...
   * @throws IOException
   */
  public void seek(long position) throws UnsupportedOperationException, IOException {
