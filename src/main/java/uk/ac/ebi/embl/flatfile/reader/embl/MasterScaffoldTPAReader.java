...
public class MasterScaffoldTPAReader extends MultiLineBlockReader {

	public MasterScaffoldTPAReader(LineReader lineReader) {
		super(lineReader, ConcatenateType.CONCATENATE_SPACE);
	}

	@Override
	public String getTag() {
		return EmblTag.MASTER_SCAFFOLD_TPA_TAG;
	}
	
	@Override
	protected void read(String block) {
		entry.setContigDataclass(Entry.TPA_DATACLASS);
