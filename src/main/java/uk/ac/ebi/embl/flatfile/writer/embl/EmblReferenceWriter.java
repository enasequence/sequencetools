...
public class EmblReferenceWriter extends FlatFileWriter{
    ...
    public boolean write(Writer writer) throws IOException {
    	...
    	writeBlock |=
    		new RNWriter(entry, reference, wrapType).write(writer);
    	writeBlock |=
    		new RCWriter(entry, reference, wrapType).write(writer);
    	writeBlock |=
    		new RPWriter(entry, reference, wrapType).write(writer);
    	writeBlock |=
