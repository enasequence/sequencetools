...
/** Reader for the flat file RX lines. */
public class RXReader extends SingleLineBlockReader {

  public RXReader(LineReader lineReader) {
    super(lineReader);
  }

  @Override
  public String getTag() {
    return EmblTag.RX_TAG;
  }
  ...
  protected void read(String block) {
    ...
    getCache().getPublication().addXRef(xref);
  }
}
