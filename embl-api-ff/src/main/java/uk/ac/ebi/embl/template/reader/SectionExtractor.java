...
import static uk.ac.ebi.embl.template.reader.TemplateProcessorConstants.SECTION_CLOSE_DELIMITER;
import static uk.ac.ebi.embl.template.reader.TemplateProcessorConstants.SECTION_DELIMITER;
import static uk.ac.ebi.embl.template.reader.TemplateProcessorConstants.SECTION_DELIMITER;
...
public class SectionExtractor {
    ...
    static String encloseSectionStartToken(TemplateSectionInfo currentSectionInfo) {
        StringBuilder builder = new StringBuilder(SECTION_DELIMITER);
        builder.append(currentSectionInfo.getName());
        builder.append(SECTION_CLOSE_DELIMITER);
