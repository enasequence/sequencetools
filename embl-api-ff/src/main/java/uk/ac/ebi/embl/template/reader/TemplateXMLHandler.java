...
public class TemplateXMLHandler extends DefaultHandler {
    ...
    /**
     * keep a local copy of the tokens despite their being stored in the template - speeds up access where needed here
     */
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        if (qName.equalsIgnoreCase("template")) {
            ...
            try {
                ...
                TemplateTokenInfo tokenInfo = new TemplateTokenInfo(name,
                        tokenType, (mand != null && mand.equals("true")),
                        displayName, description, tip);
            ...
            template.groupInfo.add(new TemplateTokenGroupInfo(name, containsStrings, description, mandatory));
