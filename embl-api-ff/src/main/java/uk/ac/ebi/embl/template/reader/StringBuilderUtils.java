...
import static uk.ac.ebi.embl.template.reader.TemplateProcessorConstants.TOKEN_CLOSE_DELIMITER;
import static uk.ac.ebi.embl.template.reader.TemplateProcessorConstants.TOKEN_DELIMITER;
...
public class StringBuilderUtils {
    ...
    public static String encloseToken(String token) {
        return new StringBuilder(TOKEN_DELIMITER).append(token).append(TOKEN_CLOSE_DELIMITER).toString();
    }
