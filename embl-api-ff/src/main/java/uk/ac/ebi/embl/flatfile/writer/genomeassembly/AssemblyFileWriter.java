...
public class AssemblyFileWriter extends GenomeAssemblyFileWriter
{
	GenomeAssemblyRecord gaRecord;

	protected AssemblyFileWriter(GenomeAssemblyRecord gaRecord)
	{
	...
	public boolean write(Writer writer)
	{
		...
		{
			writeRow(field.getKey(), field.getValue(), null, null, writer);
		}
		return true;
	}
}
