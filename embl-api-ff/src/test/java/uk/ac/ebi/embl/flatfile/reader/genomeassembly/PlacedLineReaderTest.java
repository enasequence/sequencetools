...
public class PlacedLineReaderTest extends GenomeAssemblyReaderTest
{
	@SuppressWarnings("unchecked")
	public void testReadValidLine() throws IOException
	{
		initLineReader("cb25.NA_011", GenomeAssemblyRecord.PLACED_FILE_TYPE);
		...
		assertEquals((((ArrayList<Field>) gaRecord.getFields()).get(0).getValue()), "cb25.NA_011");
	...
	{
		initLineReader("chI       Ichromosome", GenomeAssemblyRecord.PLACED_FILE_TYPE);
