...
public class DEGeneratorTest extends TestCase {
    ...
    public void testTPAFile1() throws IOException {
        ...
        EmblEntryReader entryReader = new EmblEntryReader(new BufferedReader(new StringReader(entryString)));
        entryReader.read();
    ...
    public void testOrgainsm1() throws IOException {
        ...
        features.get(0).addQualifier(qualifierFactory.createQualifier(Qualifier.ORGANISM_QUALIFIER_NAME, "chicken"));
        DEGenerator.writeDE(entry);
    ...
    public void testOrgainsm2() throws IOException {
        List<Feature> features = SequenceEntryUtils.getFeatures(Feature.SOURCE_FEATURE_NAME, entry);
        features.get(0).addQualifier(qualifierFactory.createQualifier(Qualifier.ORGANISM_QUALIFIER_NAME, "chicken"));
        features.get(0).addQualifier(qualifierFactory.createQualifier(Qualifier.NOTE_QUALIFIER_NAME, "endogenous retrovirus"));
        DEGenerator.writeDE(entry);
    ...
    public void testOrgainsm3() throws IOException {
        List<Feature> features = SequenceEntryUtils.getFeatures(Feature.SOURCE_FEATURE_NAME, entry);
        features.get(0).addQualifier(qualifierFactory.createQualifier(Qualifier.ORGANISM_QUALIFIER_NAME, "chicken"));
        features.get(0).addQualifier(qualifierFactory.createQualifier(Qualifier.PROVIRAL_QUALIFIER_NAME));
        features.get(0).addQualifier(qualifierFactory.createQualifier(Qualifier.NOTE_QUALIFIER_NAME, "endogenous retrovirus"));
        DEGenerator.writeDE(entry);
    ...
    public void testOrganelle1() throws IOException {
        List<Feature> features = SequenceEntryUtils.getFeatures(Feature.SOURCE_FEATURE_NAME, entry);
        features.get(0).addQualifier(qualifierFactory.createQualifier(Qualifier.ORGANELLE_QUALIFIER_NAME, "blah blah : mitochondrian gubbins"));
        features.get(0).addQualifier(qualifierFactory.createQualifier(Qualifier.PLASMID_QUALIFIER_NAME, "thingy"));
        DEGenerator.writeDE(entry);
    ...
    public void testBody1() throws IOException {
        ...
        List<Feature> features = SequenceEntryUtils.getFeatures(Feature.SOURCE_FEATURE_NAME, entry);
        features.get(0).addQualifier(qualifierFactory.createQualifier(Qualifier.ISOLATE_QUALIFIER_NAME, "urine"));
        features.get(0).addQualifier(qualifierFactory.createQualifier(Qualifier.CLONE_QUALIFIER_NAME, "cb1"));
        features.get(0).addQualifier(qualifierFactory.createQualifier(Qualifier.MAP_QUALIFIER_NAME, "kinase"));
        DEGenerator.writeDE(entry);
    ...
    public void testBody2() throws IOException {
        ...
        cdsFeature.addQualifier(qualifierFactory.createQualifier(Qualifier.PRODUCT_QUALIFIER_NAME, "p1"));
    ...
    public void testBody3() throws IOException {
        ...
        geneFeature.addQualifier(qualifierFactory.createQualifier(Qualifier.PRODUCT_QUALIFIER_NAME, "p1"));
    ...
    public void testBody4() throws IOException {
        ...
        cdsFeature2.addQualifier(qualifierFactory.createQualifier(Qualifier.PRODUCT_QUALIFIER_NAME, "p2"));
...
//        entry.setDataClass(Entry.STANDARD_DATACLASS);
        List<Feature> features = SequenceEntryUtils.getFeatures(Feature.SOURCE_FEATURE_NAME, entry);
        features.get(0).addQualifier(qualifierFactory.createQualifier(Qualifier.ISOLATE_QUALIFIER_NAME, "urine"));
        features.get(0).addQualifier(qualifierFactory.createQualifier(Qualifier.STRAIN_QUALIFIER_NAME, "s1"));
...
//        entry.setDataClass(Entry.STANDARD_DATACLASS);
        ...
        feature.addQualifier(qualifierFactory.createQualifier(Qualifier.CHROMOSOME_QUALIFIER_NAME, "3"));
        feature.addQualifier(qualifierFactory.createQualifier(Qualifier.ISOLATE_QUALIFIER_NAME, "urine"));
...
//        entry.setDataClass(Entry.STANDARD_DATACLASS);
    ...
    public void testBody6() throws IOException {
        ...
        cdsFeature.addQualifier(qualifierFactory.createQualifier(Qualifier.PRODUCT_QUALIFIER_NAME, "c1"));
        entry.addFeature(cdsFeature);
    ...
    public void testBody7() throws IOException {
        ...
        geneFeature2.addQualifier(qualifierFactory.createQualifier(Qualifier.GENE_QUALIFIER_NAME, "g2"));
        geneFeature2.addQualifier(qualifierFactory.createQualifier(Qualifier.PRODUCT_QUALIFIER_NAME, "g2"));
    ...
    public void testCircularSegmentFile() throws IOException {
        ...
        assertEquals("Faba bean necrotic stunt virus segment DNA-U4 complete sequence, isolate JKI-1998/99", deLine);
    }
