...
public class XmlThesisWriterTest extends XmlWriterTest {
	...
	public void testWrite() throws IOException {
        ...
        assertTrue(new XmlReferenceLocationWriter(entry, thesis).write(new SimpleXmlWriter(writer)));
        //System.out.print(writer.toString());
        assertEquals(
        		"<referenceLocation>\n" +
        		"Thesis (1998), Universitaet Muenchen.\n" +
        		"</referenceLocation>\n",
        		writer.toString());        
	}
}
